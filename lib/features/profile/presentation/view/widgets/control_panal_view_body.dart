...
import 'package:sinna/features/profile/presentation/view/widgets/subject_item_control_panal_widget.dart';

class ControlPanalViewBody extends StatefulWidget {
  const ControlPanalViewBody({super.key});

  @override
  State<ControlPanalViewBody> createState() => _ControlPanalViewBodyState();
}

class _ControlPanalViewBodyState extends State<ControlPanalViewBody> {
