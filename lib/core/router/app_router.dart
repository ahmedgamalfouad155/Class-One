...
abstract class AppRouter {
  ...
  static String kTermView = '/termView';
  static String kInstructorView = '/instructorView';
  ...
  static GoRouter router(BuildContext context) => GoRouter(
    ...
    //   print("auth State is ==== ${authState.status}");

    //   final isLoggingIn =
    //       state.fullPath == kLogInView || state.fullPath == kSignUpView;
